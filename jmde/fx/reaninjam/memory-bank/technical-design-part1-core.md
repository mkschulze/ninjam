...
│   │   │             │   │   │             │   │   │             │  │
│   │   ▼             │   │   ▼             │   │   ▼             │  │
│   │ AudioProc()     │   │ state_mutex     │   │ drain ui_queue  │  │
│   │ (no lock)       │   │   │             │   │   │             │  │
│   │   │             │   │   ▼             │   │   ▼             │  │
│   │   ▼             │   │ Run()           │   │ check license   │  │
│   │ read atomics    │   │   │             │   │   │             │  │
...
│   │  std::mutex state_mutex      ◄── Run + UI (not Audio)     │   │
...
|-----------|------|-------|---------|
| `state_mutex` | `std::mutex` | Plugin | Protects NJClient API calls |
...
2. `state_mutex` (if needed)

**Never hold `state_mutex` while waiting on `license_cv`.**
...
struct NinjamPlugin {
    ...
    std::string local_channel_name{"Channel"};
    int local_channel_bitrate{64};
    bool local_channel_transmit{true};
